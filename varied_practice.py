...
import os.path
import datetime
from problem_engine import generate_problem
from problem_engine import PROBLEM_DOMAIN_POSITIVE_NEGATIVE
from problem_engine import PROBLEM_TYPE_VARIED
...
while True:
    ...
    problem, answer = generate_problem(prob_type=PROBLEM_TYPE_VARIED, prob_domain=PROBLEM_DOMAIN_POSITIVE_NEGATIVE)
    print(f"\n\n\nWhat is {problem}   =  ?")
